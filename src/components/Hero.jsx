...
const Hero = () => {
  ...
  const defaultMessage = encodeURIComponent(
    "Hello AquaWash Laundry, I'd like to inquire about your services.",
  );
    ...
    <section className="relative bg-gradient-to-br from-aqua-500 via-aqua-400 to-blue-500 text-white py-20 md:py-32 px-4 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center">
          <div className="mx-auto mb-8 h-36 w-36 md:h-44 md:w-44 rounded-full bg-white shadow-lg flex items-center justify-center p-3">
            <img
              src={logo}
